...
1. Exact chunk/segment duration and codec choices for both calls and streams — implementation-level tuning, not architectural.

This was the last remaining open item in this document; every other question originally flagged (mesh↔relay renegotiation, relay failover, live-propagation tier assignment) has been resolved in the sections above.
